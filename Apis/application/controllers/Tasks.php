...
class Tasks extends REST_Controller
{
    ...
    public function vouchers_post($id = 0)
    {
        try {
            ...
            $vouch = [
                ...
                'IsPosted'    => intval($data['IsPosted'] ?? 0),
                'FinYearID'   => intval($data['FinYearID'] ?? 1),
                'RefType'     => intval($data['RefType'] ?? 0),
                'BusinessID'  => intval($data['BusinessID'] ?? 1),
            ];
    ...
    public function vouchers_options()
    {
        header('Access-Control-Allow-Headers: X-Requested-With, content-type, access-control-allow-origin, access-control-allow-methods, access-control-allow-headers');
    ...
    public function booking_post($id = null)
    {
        ...
        $sales = isset($post_data['sales']) ? $post_data['sales'] : [];
        $orderIDs = [];
